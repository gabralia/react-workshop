...
describe('input', () => {
    it('should return text input when pass type is text', () => {
        ...
        const { getByLabelText } = render(<Input id='test' type='text' handleChange={handleChange} value="fake-value"/>);
    ...
    it('should return submit input when pass type is submit', () => {
        const { getByLabelText } = render(<Input id='test' type='submit'/>);
    ...
    it('should return radio input when pass type is radio', () => {
        ...
        const { getByLabelText } = render(<Input id='test' type='radio' items={['fake-option-1', 'fake-option-2']}
